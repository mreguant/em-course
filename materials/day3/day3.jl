...
# ╔═╡ 5c8ee39a-57fd-4a47-92d7-55d3ba64a1d2
begin
	using CSV, Tables 
...
# ╔═╡ 566b4452-643b-49a4-984d-b280319721a8
# A trick to make the notebook wider
...
# ╔═╡ a1e0a9ba-ec83-4c0d-b33c-fca8a5819ee1
md"""
...
begin
	...
	for x in datasets
		data[string(x)] = CSV.File(string("data_leakage/",x,".csv"), header=false) |> Tables.matrix;
	end
end
...
The model follows similar steps from yesterday:
...
Now that we have a function that generates outcomes from one hour, we can loop to get results for the entire period.

**Disclaimer**: This is not the cleanest way of doing this. I have been lately using DataFrames for cleaner handling. But this has the advantage of preserving a lot of detail about the solution.

**Warning**: This loop can take a bit of time. Feel free to reduce the number of periods it is looping over by modifying the time loop.
