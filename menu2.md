...
* **Practicum 3**: [practicum3.ipynb](/materials/day2/practicum3.ipynb), [data\_jaere\_clustered.csv](/materials/day1/data_jaere_clustered.csv),[data_technology.csv](/materials/day1/data_technology.csv), [practicum3_slides.pdf](/materials/day2/practicum3_slides.pdf)
* **Practicum 4**: [practicum4.ipynb](/materials/day2/practicum4.ipynb), [data\_jaere\_clustered.csv](/materials/day1/data_jaere_clustered.csv),[data_technology.csv](/materials/day1/data_technology.csv), [practicum4_slides.pdf](/materials/day2/practicum4_slides.pdf)

* **Small assignement**: Take Practicum 3 code and consider running the market power function for alternative levels of market power (theta). What is the theta that best fits the data? Justify how you define "best fit" in your answer.
...
* Bushnell, J. (2011). Building blocks: Investment in renewable and nonrenewable technologies. In Harnessing Renewable Energy in Electric Power Systems: Theory, Practice, Policy: Vol. WP-202R (pp. 159–180). [https://doi.org/10.4324/9781936331864](https://mreguant.github.io/em-course/materials/day2/building_blocks.pdf)
